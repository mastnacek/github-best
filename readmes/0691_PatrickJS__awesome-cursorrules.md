...
- [HTMX (Flask)](https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/htmx-flask-EXAMPLE_API_KEY.mdc) - HTMX development with Flask integration.
...
- [Python (Flask JSON Guide)](https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/python-flask-EXAMPLE_API_KEY.mdc) - Python Flask development with JSON guide.
